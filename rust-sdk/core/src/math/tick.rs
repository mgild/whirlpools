...
pub fn get_full_range_tick_indexes(tick_spacing: u16) -> TickRange {
    ...
    TickRange {
        lower: min_tick_index,
        upper: max_tick_index,
    }
}
...
mod tests {
    ...
    fn test_tick_index_to_sqrt_price() {
        // Assuming get_sqrt_price_positive_tick and get_sqrt_price_negative_tick are correct
    ...
    fn test_sqrt_price_to_tick_index() {
        assert_eq!(sqrt_price_to_tick_index(18447666387855959850u128.into()), 1);
        assert_eq!(
            sqrt_price_to_tick_index(18445821805675392311u128.into()),
            -1
        );
    }
    ...
    fn test_get_full_range_tick_indexes() {
        ...
        assert_eq!(range.lower, (MIN_TICK_INDEX / 10) * 10);
        assert_eq!(range.upper, (MAX_TICK_INDEX / 10) * 10);
    }
